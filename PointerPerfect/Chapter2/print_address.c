...
int main(void)
{
  ...
  // print pointers to functions
  printf("func1..%p\n", (void*)func1);
  printf("func2..%p\n", (void*)func2);

  // print the address of string literal
  printf("string literal..%p\n", (void*)"abc");

  // print the address of global variable
  printf("&global_variable..%p\n", (void*)&global_variable);

  // print the address of static variable in file
  ...
  // print the address of the area allocated by malloc
  p = malloc(sizeof(int));
