...
// sample program from Chapter11_3
// File chapter11_3.c

/* This program asks the user their state of happiness on a scale of 1 to 10
 * and then gives a custom 2-line message on their range, either 1-2, 3-4, 5-7, or 8-10. */
...
int main(void)
{
  ...
  /* Once the user's level of happiness is entered, a series of if statements test the number against decreasing numbers. 
   * Only one of the four will be execute. */
