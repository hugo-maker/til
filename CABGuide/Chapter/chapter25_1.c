...
// sample program from Chapter25_1
// File chapter25_1.c
...
int main(void)
{
  ...
  char * movies[9] = {"Amour", "Arog", "Beats of the Southern Wild", "Django Unchained",
                      "Les Miserables", "Life of Pi", "Lincoln", "Silver Linings Playbook", "Zero Dark Thirty"};
  ...
  // Now sort the movie by rating (the unseen will go to the bottom)
