...
// sample program from Chapter12_1
// File chapter12_1.c
...
int main(void)
{
   ...
   * whether the cast of Friends and the Beatles would have enough people to make a baseball team
   * AND the cast of Friends and the Avengers would have enough people to field a football team.
  ...
  if ((friends + beatles >= baseball) && (friends + avengers >= football))
  {
    ...
    printf("AND the cast of Friends plus the Avengers couls make a football team.\n");
  }
  else
  {
   ...
   * in the year OR the number of Harry Potter books is less than months in the year.
   * If either statement is true, the statements will print. */
   ...
   * whether the number of baseball players on a team added to the number of basketball players on a team is NOT
