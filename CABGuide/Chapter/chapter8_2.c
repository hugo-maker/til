...
// sample program from Chapter8_2
// File chapter8_2.c

// This is a sample program that asks users for some basc data and prints it on screen to show what was entered
...
int main(void)
{
  ...
  // The first scanf() will look for a floating-point variable, the cost of pizza 
