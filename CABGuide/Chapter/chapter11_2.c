...
// sample program from Chapter11_2
// File chapter11_2.c

/* This program asks user for their birth year and calculates how old they will be in the current year.
