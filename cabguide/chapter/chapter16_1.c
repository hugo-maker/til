...
// sample program from Chapter16_1
// File chapter16_1.c

/* This program will ask users to input test grades for the 25 students in a class and then compute an average test grade. 
 * If fewer than 25 students took the test, the user can enter -1 as a grade 
 * and break the loop and only those entered grade will be used to compute the average. */
