...
// sample program from Chapter16_2
// File chapter16_2.c

/* This program loops through 10 numbers and prints a message that varies whether the program is odd or even.
 * It tests for odd and if the number is odd, it prints the odd message and then starts the next iteration of the loop using countinue.
...
int main(void)
{
  ...
  // Loops through the number 1 through 10
  for (i = 1;i <= 10;i++)
    {
      if ((i % 2) == 1)
      {
