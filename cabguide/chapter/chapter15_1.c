...
// sample program from Chapter15_1
// File chapter15_1.c

/* This program will ask users how many movies they've seen this year, and then loop through asking the name of each movie and a rating from 1 to 10.
 * It will their favorite movie and their least favorite movie. */
...
int main(void)
{
  ...
  // initialize the favRating to 0 so any movie with any rating of 1 or higher will replace it 
  // and the leastRating to 10 so any movie rated 9 or lower will replace it
  favRating = 0;
  leastRating = 10;
