...
// sample program from Chapter9_1
// File chapter9_1.c
...
int main(void)
{
  ...
  // Test
  intAnswer = x / b;
  printf("%d divided by %.1f equals %d\n",x,b,intAnswer);

  intAnswer = a / y;
  printf("%.1f divided by %d equals %d\n",a,y,intAnswer);

  floatAnswer = x / b;
  printf("%d divided by %.1f equals %.1f\n",x,b,floatAnswer);

  floatAnswer = a / y;
  printf("%.1f divided by %d equals %.1f\n",a,y,floatAnswer);
  // Test end
